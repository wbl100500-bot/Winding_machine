...
const char PROGMEM STRING_3[] = "ÎÁÌÎÒÊÀ %d ÑÒÀÐÒ";

const char PROGMEM MENU_01[] = "ÀÂÒÎÍÀÌÎÒÊÀ";
const char PROGMEM MENU_02[] = "ÊÎÍÔÈÃ";
...
const char PROGMEM MENU_22[] = "ÑËÎÉÑÒÎÏ";
const char PROGMEM MENU_23[] = "ÓÑÊÎÐÅÍ.";
const char PROGMEM MENU_UNWIND[] = "ÐÀÇÌÎÒÊÀ";
const char PROGMEM MENU_UWTURNS[] = "ÂÈÒÊÎÂ:";
